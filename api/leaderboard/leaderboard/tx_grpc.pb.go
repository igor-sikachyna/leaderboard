...
const (
	Msg_UpdateParams_FullMethodName   = "/leaderboard.leaderboard.Msg/UpdateParams"
	Msg_SendIbcTopRank_FullMethodName = "/leaderboard.leaderboard.Msg/SendIbcTopRank"
)
...
func (c *msgClient) SendIbcTopRank(ctx context.Context, in *MsgSendIbcTopRank, opts ...grpc.CallOption) (*MsgSendIbcTopRankResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SendIbcTopRank_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SendIbcTopRank(context.Context, *MsgSendIbcTopRank) (*MsgSendIbcTopRankResponse, error) {
...
func _Msg_SendIbcTopRank_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SendIbcTopRank_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
